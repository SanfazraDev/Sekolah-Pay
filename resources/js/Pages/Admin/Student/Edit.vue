...
const { form, submit } = useFormCrud({
    classroom_id: props.student.data.classroom.id,
    name: props.student.data.name,
    nisn: props.student.data.nisn,
...
const save = () => {
    submit({
        url: `/admin/students/update/${props.student.data.id}`,
        method: 'put',
        resetOnSuccess: true
    });
}
...
<template>
    ...
    <div class="container mx-auto py-6">
        <div class="bg-white shadow-md rounded-lg p-6">
            <h2 class="text-xl font-semibold mb-6">Edit Data Siswa</h2>
